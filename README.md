...
Vienna is created to help with web application creation. Of course, event binding is (partially) supported. At the
moment, the template engine of Vienna supports the following events:
