...
- feat(package.json): release '0.2.76' [`e3aa82d`](https://github.com/YoeriNijs/vienna/commit/e3aa82dabd2bcb80a16328c6103b32d26946b859)
...
- feat(package.json): release '0.2.74' [`1d71bfa`](https://github.com/YoeriNijs/vienna/commit/1d71bfa6c0f82f908b0c044eb39bd7b3be7602de)
...
- feat(i18n): i18n implementation [`#71`](https://github.com/YoeriNijs/vienna/pull/71)
...
- feat(pipes): initial custom pipes implementation [`#70`](https://github.com/YoeriNijs/vienna/pull/70)

### Commits

- feat(package.json): release '0.2.71' [`2480754`](https://github.com/YoeriNijs/vienna/commit/24807548466c0f982fd4986526e69ecddf60bcd2)

## [0.2.70](https://github.com/YoeriNijs/vienna/compare/0.2.69...0.2.70) - 2023-07-27
...
- feat(package.json): release '0.2.70' [`5c63633`](https://github.com/YoeriNijs/vienna/commit/5c63633843b64536b12c11383fd847f103d5042d)
...
- fix(vinternalrepeattransformer): quick fix to prevent iteration issues [`#67`](https://github.com/YoeriNijs/vienna/pull/67)

### Commits

- feat(package.json): release '0.2.68' [`a1775c2`](https://github.com/YoeriNijs/vienna/commit/a1775c27b23feb6596f68f77765a6d97f7e4b147)

## [0.2.67](https://github.com/YoeriNijs/vienna/compare/0.2.66...0.2.67) - 2023-07-10

### Merged

- fix(transformers): check value before parsing it [`#66`](https://github.com/YoeriNijs/vienna/pull/66)

### Commits

- feat(package.json): release '0.2.67' [`87f76df`](https://github.com/YoeriNijs/vienna/commit/87f76df325dc387069ca5ae37c0a13988a4a18a8)

## [0.2.66](https://github.com/YoeriNijs/vienna/compare/0.2.65...0.2.66) - 2023-07-10

### Merged

- fix(renderer): check for intervals and timeouts prior to clearing them [`#65`](https://github.com/YoeriNijs/vienna/pull/65)

### Commits

- feat(package.json): release '0.2.66' [`5c1b49b`](https://github.com/YoeriNijs/vienna/commit/5c1b49b941590a258af5bb2a933e912fb16b814c)

## [0.2.65](https://github.com/YoeriNijs/vienna/compare/0.2.64...0.2.65) - 2023-06-09

### Merged

- Revert "feat(sitemap-generator): implement a first basic sitemap generator (beta) (#63)" [`#64`](https://github.com/YoeriNijs/vienna/pull/64)

### Commits

- feat(package.json): release '0.2.65' [`211df29`](https://github.com/YoeriNijs/vienna/commit/211df2966001219448fe326faa9d4c54182c681e)

## [0.2.64](https://github.com/YoeriNijs/vienna/compare/0.2.63...0.2.64) - 2023-06-09
...
- feat(package.json): release '0.2.64' [`adea7e9`](https://github.com/YoeriNijs/vienna/commit/adea7e9f4a80db419867d09ff068305f5750d309)
...
- feat(package.json): release '0.2.58' [`a1f1881`](https://github.com/YoeriNijs/vienna/commit/a1f18813a5a96379facff370308d01b36e45d53f)
...
- test(renderer): add some missing tests [`#55`](https://github.com/YoeriNijs/vienna/pull/55)

### Commits

- feat(package.json): release '0.2.56' [`d10ed6f`](https://github.com/YoeriNijs/vienna/commit/d10ed6f10190726777d8abc6b892230407ddb0ee)

## [0.2.55](https://github.com/YoeriNijs/vienna/compare/0.2.54...0.2.55) - 2023-05-12
...
- feat(package.json): release '0.2.55' [`5bc063e`](https://github.com/YoeriNijs/vienna/commit/5bc063ed4dc37fa98f7f5812263e694be65aa31f)
...
- feat(package.json): release '0.2.52' [`0ff757b`](https://github.com/YoeriNijs/vienna/commit/0ff757bf620557ca449f72f2f8fef451ebba3b8b)
...
## [0.2.50](https://github.com/YoeriNijs/vienna/compare/0.2.49...0.2.50) - 2022-07-20

### Merged

- fix(v-switch): keep unrelated elements when updating the dom with v-switch [`#49`](https://github.com/YoeriNijs/vienna/pull/49)

### Commits

- feat(package.json): release '0.2.50' [`a8afe4a`](https://github.com/YoeriNijs/vienna/commit/a8afe4a0553c09e0880ca556ade0b96a37cc990a)

## [0.2.49](https://github.com/YoeriNijs/vienna/compare/0.2.48...0.2.49) - 2022-07-10
...
- feat(package.json): release '0.2.49' [`0a3b197`](https://github.com/YoeriNijs/vienna/commit/0a3b1971edb5069e84973bd31eaef1bbdb5a2bb5)
...
- feat(validation engine): introduce validation engine [`#46`](https://github.com/YoeriNijs/vienna/pull/46)

### Commits

- feat(package.json): release '0.2.47' [`4cc4fd5`](https://github.com/YoeriNijs/vienna/commit/4cc4fd534f41f95b4e62d3ae4d2f9e66b12b3b80)

## [0.2.46](https://github.com/YoeriNijs/vienna/compare/0.2.45...0.2.46) - 2022-07-04

### Merged

- docs(readme): fix docs [`#45`](https://github.com/YoeriNijs/vienna/pull/45)

### Commits

- feat(package.json): release '0.2.46' [`fbd09a6`](https://github.com/YoeriNijs/vienna/commit/fbd09a6d47096980b25f36641a42966448f8597c)

## [0.2.45](https://github.com/YoeriNijs/vienna/compare/0.2.44...0.2.45) - 2022-07-04
...
- feat(package.json): release '0.2.45' [`463c1ad`](https://github.com/YoeriNijs/vienna/commit/463c1ad4af229c4310273911b85ac37b29eff5a5)
...
- fix(vapplication): restore initial doc tags when none exist [`#42`](https://github.com/YoeriNijs/vienna/pull/42)

### Commits

- feat(package.json): release '0.2.42' [`d231a30`](https://github.com/YoeriNijs/vienna/commit/d231a3069c2983cb614c1d78005c4e521a82a797)

## [0.2.41](https://github.com/YoeriNijs/vienna/compare/0.2.40...0.2.41) - 2022-04-22
...
- feat(package.json): release '0.2.41' [`ecabe66`](https://github.com/YoeriNijs/vienna/commit/ecabe668ae51d8dc98eacda4ba82bee71ce05024)
...
## [0.2.39](https://github.com/YoeriNijs/vienna/compare/0.2.38...0.2.39) - 2022-04-22
...
- feat(package.json): release '0.2.39' [`1e9818e`](https://github.com/YoeriNijs/vienna/commit/1e9818ec20b2bb409eae5c0ad77ab438b7360323)
...
- feat(package.json): release '0.2.36' [`93b88eb`](https://github.com/YoeriNijs/vienna/commit/93b88eb921992990e3a214f980b7f9a5e43fe7e0)
...
- feat(package.json): release '0.2.33' [`23435c0`](https://github.com/YoeriNijs/vienna/commit/23435c0a9bea2ab37bbb316878d6e20bf70e6419)
...
- feat(vaudit): initial VAudit implementation with some validators [`#32`](https://github.com/YoeriNijs/vienna/pull/32)

### Commits

- feat(package.json): release '0.2.30' [`1fb0892`](https://github.com/YoeriNijs/vienna/commit/1fb08929add43a0160d64a76c89bc2a53d3c1994)

## [0.2.29](https://github.com/YoeriNijs/vienna/compare/0.2.28...0.2.29) - 2022-03-24

### Merged

- feat(logger): simple logger implementation [`#31`](https://github.com/YoeriNijs/vienna/pull/31)

### Commits

- feat(package.json): release '0.2.29' [`7691297`](https://github.com/YoeriNijs/vienna/commit/76912973776393e8bf90b973479f5a224b32d3b0)

## [0.2.28](https://github.com/YoeriNijs/vienna/compare/0.2.27...0.2.28) - 2022-03-20
...
- feat(package.json): release '0.2.28' [`0c14e6e`](https://github.com/YoeriNijs/vienna/commit/0c14e6e669357136b4a602ebf1ad48a6f833becd)
...
- feat(package.json): release '0.2.6' [`ed1aeae`](https://github.com/YoeriNijs/vienna/commit/ed1aeae05297f28da1c713b983c9b09e46736c67)
- ci(github actions): clean up [`6cbb07b`](https://github.com/YoeriNijs/vienna/commit/6cbb07bd409ecd7a5dad8f73c08570583781deb9)
- chore(release.sh): remove old release script [`872e8ae`](https://github.com/YoeriNijs/vienna/commit/872e8aeb05d67b9ae132337884e49c2999bdcf87)

## [0.2.5](https://github.com/YoeriNijs/vienna/compare/0.2.0...0.2.5) - 2022-01-09

### Commits

- feat(package.json): release '0.2.5' [`797fdfe`](https://github.com/YoeriNijs/vienna/commit/797fdfeccfb5fd038e86242319449b8c07986e5a)
- ci(github actions): master is main ofc [`99bfe6d`](https://github.com/YoeriNijs/vienna/commit/99bfe6ddbfb179eaa3b17bce2326713886f761e5)
- ci(github actions): run install, skip sanity checks on push to main [`440ead7`](https://github.com/YoeriNijs/vienna/commit/440ead7d81d54f8606870ec433ba2f56466a8176)
- ci(github actions): test [`091eef1`](https://github.com/YoeriNijs/vienna/commit/091eef1ee6c8909bca669b1d68956fa907d85d45)
- ci(github actions): release on push main [`c5c5964`](https://github.com/YoeriNijs/vienna/commit/c5c596433e3109fb90a4d9639f9bfd99fcb45768)
- ci(github actions): no name [`461baee`](https://github.com/YoeriNijs/vienna/commit/461baee5b4507b5de7e3b75e3df402a5389454bf)
- ci(github actions): add ext [`5d88ad8`](https://github.com/YoeriNijs/vienna/commit/5d88ad8fd0b2d78d92b283c7fd197fc8dad22673)
- ci(github actions): use sanity checks [`408cd91`](https://github.com/YoeriNijs/vienna/commit/408cd91d40d28f0603ca0937d57c8dfbd2d5334b)
- ci(package.json): remove postversion hook [`53c8440`](https://github.com/YoeriNijs/vienna/commit/53c844018706d8aab0a005817e18f76846215fde)
- ci(github actions): new release action [`d7f4380`](https://github.com/YoeriNijs/vienna/commit/d7f4380a53f388786a2890b4748ae1e9a577c726)
- ci(github actions): release action [`926eb92`](https://github.com/YoeriNijs/vienna/commit/926eb924ca226e5a80d6c9b5b24a8842ab9124ad)
- ci(github actions): run sanity checks for pull requests as well [`b5b2ebe`](https://github.com/YoeriNijs/vienna/commit/b5b2ebe13c49c9e71e8b664690c6e06b8ee66fa4)
- test(tests): enable fake timers for all tests with Jest [`19d7eb2`](https://github.com/YoeriNijs/vienna/commit/19d7eb2fe62b30f5cf4800852677bb31a98c106b)
- build(github actions): test [`c14f39c`](https://github.com/YoeriNijs/vienna/commit/c14f39c5ddf7b4fe6bf7860b44f555711d808d70)
- build(github actions): test [`1acf21a`](https://github.com/YoeriNijs/vienna/commit/1acf21a91c34d22dc13ef1cc54eaf4d8e94c6206)
- build(github actions): change dir [`9ba7197`](https://github.com/YoeriNijs/vienna/commit/9ba7197641294a7f030ed2f4592313583a5b49af)
- build(github actions): add npm install [`55893dc`](https://github.com/YoeriNijs/vienna/commit/55893dcf3b0ddcc606879e3f448ed36fd660ecf7)
- ci(github actions): creating On Push hook on Github Actions to perform some sanity checks [`0399176`](https://github.com/YoeriNijs/vienna/commit/03991768849cde0e1ae5889e64d7ef166bdd519d)
- ci(github actions): experimenting with GitHub Actions [`a3c451c`](https://github.com/YoeriNijs/vienna/commit/a3c451cfc0d4fe3b897d7f19c6643a0d4793fb77)
- docs(readme): update docs [`04cf536`](https://github.com/YoeriNijs/vienna/commit/04cf53652178b215c3f2b361558828cf03d7fa81)
- docs(changelog): update changelog [`dacc657`](https://github.com/YoeriNijs/vienna/commit/dacc657fffd11ddab339beab40bcb30b2fe6ef18)
- fix(package.json): fix import from js file [`dc14365`](https://github.com/YoeriNijs/vienna/commit/dc14365bcc3208f3aedf95fdbe62af1165065ea9)
- fix(package.json): fix import from js file [`32bfa2a`](https://github.com/YoeriNijs/vienna/commit/32bfa2a9e49cb9023b07bf34f2a1a180592a52bf)
- Update CHANGELOG.md [`77ac5cd`](https://github.com/YoeriNijs/vienna/commit/77ac5cd2f0423a12984bf63c9a85e1a5257a8d7b)
- docs(changelog): update changelog [`417675e`](https://github.com/YoeriNijs/vienna/commit/417675e66ceee56381d9b883243ea7b4a5ec0f88)
