...
describe('VInternalRepeatTransformer', () => {
    ...
    //
    // describe('ordering', () => {
    //     it('should render v-repeat first', () => {
    //         const html = `<v-repeat let="{{ i }}" for="[1]"><span>{{ i }}</span></v-repeat><span>2</span>`;
    //         const result = transform(html);
    //         expect(result).toEqual('<span>1</span><span>2</span>');
    //     });
    //
    //     it('should render v-repeat last', () => {
    //         const html = `<span>1</span><v-repeat let="{{ i }}" for="[2]"><span>{{ i }}</span></v-repeat>`;
    //         const result = transform(html);
    //         expect(result).toEqual('<span>1</span><span>2</span>');
    //     });
    //
    //     it('should render v-repeat in between', () => {
    //         const html = `<span>1</span><v-repeat let="{{ i }}" for="[2]"><span>{{ i }}</span></v-repeat><span>3</span>`;
    //         const result = transform(html);
    //         expect(result).toEqual('<span>1</span><span>2</span><span>3</span>');
    //     });
    // });

    describe('multiple', () => {
        it('should render multiple repeats', () => {
            const html = `<v-repeat let="{{ i }}" for="[1]"><span>{{ i }}</span></v-repeat><v-repeat let="{{ i }}" for="[2]"><span>{{ i }}</span></v-repeat>`;
            const result = transform(html);
            expect(result).toEqual('<span>1</span><span>2</span>');
        });
    });
